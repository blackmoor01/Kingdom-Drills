        ...
        <div name={"home"} className="flex-1 ">
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center mx-4 md:mx-20">
                    <div className=" md:max-w-[40%] text-white items-center">
                        <h1 className="text-xs md:text-2xl px-4 md:px-5 font-bold mb-4 max-h-5">BEST BOREHOLE DRILLING COMPANY IN GHANA FOR
                            THE PAST 15
                            YEARS</h1>
                        <p className="text-xs md:text-base px-4 md:px-5 py-0.5 md:py-10 font-medium mb-2">With Over 15 Years Of Invaluable Experience
